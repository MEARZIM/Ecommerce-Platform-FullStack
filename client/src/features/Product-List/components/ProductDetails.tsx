...
export default function ProductDetails() {
    const productDetils: Product[] = useSelector(selectProductById);
    const dispatch = useDispatch<AppDispatch>();
    const product = productDetils[0];
    ...
    useEffect(() => {
        console.log(params)
        dispatch(fetchProductByIdAsync(params.id as string));
    }, [dispatch, params.id]);


    if (!product || !product.images) {
        return <div>Loading...</div>; // You can render a loading indicator or an error message here
    }
